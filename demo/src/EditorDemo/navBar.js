  ...
  <>
    ...
    >
      <div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <span className="navDropdownMenu-item-text">Protocol</span>
                  </a>
                </li>
                <li className="divider"></li>
              </div>
              <div>
                ...
                >
                  <a tabIndex="0" className="navDropdownMenu-item">
                    ...
                    <span className="navDropdownMenu-item-text">Molecule</span>
                    <svg
                      aria-hidden="true"
                      focusable="false"
                      data-prefix="fas"
        ...
        <div className="_wvwl4m _kk5mry">
          <div
            className="_gtdwdr"
            data-test-component="NavBarIcon"
            data-test-key="onboardingChecklists"
            data-original-title=""
            title=""
          >
            <div className="_1n7yfxd">
              <svg
                ...
                className="svg-inline--fa fa-square-check _f9e8qy"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                data-test-component="BenchlingIcon"
                data-test-key="checklist"
              >
                <path
                  fill="currentColor"
          ...
          <div className="_1fo2909"></div>
        </div>
        <div className="_17bbufag dropdown">
          <div
          ...
          <ul className="navDropdownMenu dropdown-menu dropdown-menu--dropRightUp">
            ...
            <div>
              ...
              >
                <a
                  ...
                  data-test-element="item"
                  href="/dracarys-20/template-collections/"
                >
                  <svg
                    aria-hidden="true"
                    focusable="false"
                  ...
                  <div>
                    ...
                    >
                      <a
                        tabIndex="0"
                        className="navDropdownMenu-item"
                        href="/dracarys-20/assay-schemas/runs/"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="1em"
                    ...
                    >
                      <a
                        tabIndex="0"
                        className="navDropdownMenu-item"
                        href="/dracarys-20/assay-schemas/results/"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="1em"
                    ...
                    >
                      <a
                        tabIndex="0"
                        className="navDropdownMenu-item"
                        href="/dracarys-20/assay-schemas/requests/"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="1em"
                  ...
                  <div>
                    ...
                    >
                      <a
                        tabIndex="0"
                        className="navDropdownMenu-item"
                        href="/dracarys-20/feature-libraries"
                      >
                        <svg
                          aria-hidden="true"
                          focusable="false"
              ...
              >
                ...
                >
                  ...
                  <span className="navDropdownMenu-item-text">Data export</span>
                </a>
              </li>
              <li className="divider"></li>
            </div>
            <div>
              ...
              <li
                ...
                data-test-element="item"
              >
                <a tabIndex="0" className="navDropdownMenu-item" href="/invite">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fas"
